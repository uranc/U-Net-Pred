...
def make_pconv_uvgg(nets_in,
    ...
    nets, masks = decoder_partial_vgg(
        nets, masks, cnets_4, cmasks_4, 512, 1, 'vblock6', use_inst=use_inst)
    nets, masks = decoder_partial_vgg(
        nets, masks, cnets_3, cmasks_3, 256, 1, 'vblock7', use_inst=use_inst)
    nets, masks = decoder_partial_vgg(
        nets, masks, cnets_2, cmasks_2, 128, 1, 'vblock8', use_inst=use_inst)
    nets, masks = decoder_partial_vgg(
        nets, masks, cnets_1, cmasks_1, 64, 1, 'vblock9', use_inst=use_inst)
